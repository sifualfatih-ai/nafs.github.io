...
export default function NafsPremiumApp() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#2a0f4a] via-[#1a0b2e] to-[#0c0516] text-white">
      {!isLoggedIn && <div className="fixed inset-0 z-40" aria-hidden="true" style={{ background: "transparent" }} />}
            ...
            <div className="sticky top-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-3 mb-3">
                ...
                <p className="text-[11px] text-white/60 mt-2 leading-relaxed">
                  {isLoggedIn ? "Langganan aktif. Nikmati semua fitur premium."
                ...
                <div className="grid gap-3">
                  ...
                  <div className="flex flex-col lg:flex-row items-stretch gap-3">
                    ...
                    <div className="w-full lg:w-auto grid place-items-center">
                      {!isLoggedIn ? (
                        <a href={LOGIN_URL} className="relative z-50 inline-flex items-center gap-2 rounded-xl px-4 py-2 bg-gradient-to-r from-purple-500 to-fuchsia-600 text-sm font-medium shadow-lg">
